...
namespace DreamPlace.Libs.NetCore.Rx
{
	...
	public static class Registry<TTargetType, TValue>
	{
		...
		public static void Subscribe(Action<object, RegistryEventArgs<TValue>> subscriber, object id)
		{
		...
		public static void Subscribe<TSenderType>(Action<object, RegistryEventArgs<TValue>> subscriber, object id)
		{
		...
		public static void OnNext(object o, RegistryEventArgs<TValue> e, object id)
		{
			var targetElement = Find(id);

			targetElement?.EventAction?.Invoke(o, e);
		}

		private static RegistryElement<TValue> Find(object id)
		{
			return _values.FirstOrDefault(el => el?.Id == id);
		}
		private static RegistryElement<TValue> Find<TSender>(object id)
		{
			return _values.FirstOrDefault(el => el?.Id == id && el?.SourceType == typeof(TSender));
		}
